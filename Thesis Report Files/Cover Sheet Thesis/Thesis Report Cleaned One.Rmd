...
```{r, echo=FALSE, message=FALSE, fig.width= 12, fig.height=3,fig.cap="Line Graph of Total Magnetic Field Strength between 72 and 74th day of the year 2005"}
...
It is crucial to analyze the effect of Position of Spacecraft in predicting the event based on this dataset.
